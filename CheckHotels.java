...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"JW Marriot Hotel","Mandarin Oritental Hotel","Four Seasons Hotel","Radission Hotel","Classio Hotel","The NaVy Club Hotel","Breeze Blue Hotel","Quick Stop Hotel","Happy Moring Hotel","Moss View Hotel"};
    ...
    CheckHotels(){
       ...
       caption = new JLabel();
       caption.setBounds(80,390,1000,70);
       ...
       add(caption);
        ...
        for(int i=0;i<=9;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("tourandtravel/icons/hotel"+(i+1)+".jpg"));
